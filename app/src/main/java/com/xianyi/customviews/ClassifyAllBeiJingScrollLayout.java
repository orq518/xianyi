...
/**
 * ${todo}<分类页面-全北京适配器－可以左右滑动切换屏幕的类>
 *
 * @author lht
 * @data: on 15/11/30 14:21
 */
public class ClassifyAllBeiJingScrollLayout extends ViewGroup {

	private static final String TAG = "ClassifyAllBeiJingScrollLayout";
	...
	public ClassifyAllBeiJingScrollLayout(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		// TODO Auto-generated constructor stub
	}

	public ClassifyAllBeiJingScrollLayout(Context context, AttributeSet attrs, int defStyle) {
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_UP:
			...
			LogUtil.d(TAG, "velocityX:" + velocityX);

			if (velocityX > SNAP_VELOCITY && mCurScreen > 0) {
				// Fling enough to move left
				LogUtil.d(TAG, "snap left");
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		// TODO Auto-generated method stub
		LogUtil.d(TAG, "onInterceptTouchEvent-slop:" + mTouchSlop);
